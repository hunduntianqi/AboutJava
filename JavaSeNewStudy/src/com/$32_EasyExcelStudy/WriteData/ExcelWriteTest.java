...
public class ExcelWriteTest {
    ...
    public void writeData1() {
        // 1. 创建一个Excel文档
        String fileName = "src/com/$32_EasyExcelStudy/FileStorage/excel_test1.xlsx";
        // 2. 根据User类模板构建数据
    ...
    public void writeData2() {
        // 1. 创建一个Excel文档
        String fileName = "src/com/$32_EasyExcelStudy/FileStorage/excel_test2.xlsx";
        // 2. 根据User类模板构建数据
        List<User> list = new ArrayList<>();
        User user1 = new User(1001, "郭鹏涛", "男", 6230.5, new Date());
        User user2 = new User(1002, "郭鹏强", "男", 12000.0, new Date());
    ...
    public void writeDate3() {
        ...
        String fileName = "src/com/$32_EasyExcelStudy/FileStorage/excel_test3.xlsx";
        // 2. 根据User类模板构建数据
        List<User> list = new ArrayList<>();
        User user1 = new User(1001, "郭鹏涛", "男", 6230.5, new Date());
        User user2 = new User(1002, "郭鹏强", "男", 12000.0, new Date());
    ...
    public void writeDate4() {
        // 1. 定义文件路径, 创建一个Excel文档
        String fileName = "src/com/$32_EasyExcelStudy/FileStorage/excel_test4.xlsx";
        // 2. 根据User类模板构建数据
        List<User> list = new ArrayList<>();
        User user1 = new User(1001, "郭鹏涛", "男", 6230.5, new Date());
        User user2 = new User(1002, "郭鹏强", "男", 12000.0, new Date());
    ...
    public void writeDate5() {
        // 1. 定义文件路径, 创建一个Excel文档
        String fileName = "src/com/$32_EasyExcelStudy/FileStorage/excel_test5.xlsx";
    ...
    public void writeDate6() {
        // 1. 定义文件路径, 创建一个Excel文档
        String fileName = "src/com/$32_EasyExcelStudy/FileStorage/excel_test6.xlsx";
    ...
    public void writeData7() {
        // 1. 创建一个Excel文档
        String fileName = "src/com/$32_EasyExcelStudy/FileStorage/excel_test7.xlsx";
        // 2. 根据User类模板构建数据
        List<User> list = new ArrayList<>();
        User user1 = new User(1001, "郭鹏涛", "男", 6230.5, new Date());
        User user2 = new User(1002, "郭鹏强", "男", 12000.0, new Date());
    ...
    public void writeData8() {
        // 1. 创建一个Excel文档
        String fileName = "src/com/$32_EasyExcelStudy/FileStorage/excel_test8.xlsx";
        // 2. 根据User类模板构建数据
        List<User> list = new ArrayList<>();
        User user1 = new User(1001, "郭鹏涛", "男", 6230.5, new Date());
        User user2 = new User(1002, "郭鹏强", "男", 12000.0, new Date());
    ...
    public void writeData9() {
        // 1. 创建一个Excel文档
        String fileName = "src/com/$32_EasyExcelStudy/FileStorage/excel_test9.xlsx";
        // 2. 根据User类模板构建数据
    ...
    public void writeData10() {
        // 1. 创建一个Excel文档
        String fileName = "src/com/$32_EasyExcelStudy/FileStorage/excel_test10.xlsx";
        // 2. 构建数据
    ...
    public void writeData11() throws Exception {
        ...
        String fileName = "src/com/$32_EasyExcelStudy/FileStorage/excel_test11.xlsx";
        // 2. 构建数据(五种写入图片方式)
        List<ImageData> list = new ArrayList<>();
        ImageData imageData = new ImageData();
        imageData.setFile(new File("src/com/$32_EasyExcelStudy/FileStorage/52196720552427712321666885798167.jpg"));
        imageData.setInputStream(new FileInputStream(new File("src/com/$32_EasyExcelStudy/FileStorage/52196720552427712321666885798167.jpg")));
        imageData.setString("src/com/$32_EasyExcelStudy/FileStorage/52196720552427712321666885798167.jpg");
        imageData.setUrl(new URL("https://android-screenimgs.25pp.com/fs08/2016/08/20/3/102_e3a9f08466858f0409a54dd66d5cad6d.jpeg"));
        byte[] bytes = new byte[(int) new File("src/com/$32_EasyExcelStudy/FileStorage/52196720552427712321666885798167.jpg").length()];
        FileInputStream fileInputStream = new FileInputStream("src/com/$32_EasyExcelStudy/FileStorage/52196720552427712321666885798167.jpg");
    ...
    public void writeData12() {
        // 1. 创建一个Excel文档
        String fileName = "src/com/$32_EasyExcelStudy/FileStorage/excel_test12.xlsx";
        // 2. 构建数据
    ...
    public void writeData13() {
        // 1. 创建一个Excel文档
        String fileName = "src/com/$32_EasyExcelStudy/FileStorage/excel_test13.xlsx";
        // 2. 构建数据
